...
---|---|---
**EAX** | Accumulator | To store the return value of a function and as a special register for certain calculations
**EBX** | Base | non-volatile general-purpose register
**ECX** | Counter | volatile general-purpose register that is occasionally used as a function parameter or as a loop counter
**EDX** | Data | volatile general-purpose register that is occasionally used as a function parameter
**ESP** | Stack Pointer | stores the address of the last program request 
**EIP** | Instruction Pointer | register that holds the memory address of the instruction to be executed next
